<template>
  <b-container>
    <div class="p-2 mb-5">
      ...
      <h3><span>HayuBaca!</span> merupakan platform digital yang menampung para penjelajah internet untuk bertukar dan berbagi informasi menarik seputar dunia secara gratis!</h3>
      <br />
      <div>
        <div v-if="guest">
          <h5>Bergabunglah bersama kami untuk mendaptakan berita terpercaya dan terbaru.</h5>
          <router-link to="/signup">
            <b-button pill variant="success"> Daftar <b-icon icon="arrow-right-circle"></b-icon> </b-button>
          </router-link>
        </div>
      </div>
    </div>
    <b-row class="d-flex justify-content-center">
      <b-col col lg="8">
        <b-carousel id="carousel-fade" fade indicators controls style="text-shadow: 1px 1px 2px #000; margin: auto" @sliding-start="onSlideStart" @sliding-end="onSlideEnd">
          <b-carousel-slide
            v-for="blog in blogs"
            :key="`blog-` + blog.id"
            :blog="blog"
